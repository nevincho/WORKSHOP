...
- Target repository/runtime: NOT VERIFIED in this registry; discover from current evidence before modification.
- Expected execution path: Pi4 / SSH when available and authorized.
